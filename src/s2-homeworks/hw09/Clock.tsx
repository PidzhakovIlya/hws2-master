...
function Clock() {
    ...
    const start = () => {
        const startIntertval = setInterval(() => {
            setDate(new Date())
        }, 1000)
        console.log(startIntertval)
        setTimerId(Number(startIntertval))
    ...
    const stringMonth = new Intl.DateTimeFormat("en", {month: "long"}) // пишут студенты
